...
#define P_IOA_DA              0x2000
#define P_IOA_BU              0x2001
#define P_IOA_DI              0x2002
#define P_IOA_AT              0x2003
#define P_IOB_DA              0x2004
#define P_IOB_BU              0x2005
#define P_IOB_DI              0x2006
#define P_IOB_AT              0x2007
#define P_IOX_CT              0x2008

#define PS_IOA_Data            ((volatile  REG)       0x2000)
#define PS_IOA_Buffer          ((volatile  REG)       0x2001)
#define PS_IOA_Dir             ((volatile  REG)       0x2002)
#define PS_IOA_Attrib          ((volatile  REG)       0x2003)
#define PS_IOB_Data            ((volatile  REG)       0x2004)
#define PS_IOB_Buffer          ((volatile  REG)       0x2005)
#define PS_IOB_Dir             ((volatile  REG)       0x2006)
#define PS_IOB_Attrib          ((volatile  REG)       0x2007)
#define PS_IO_Ctrl             ((volatile  REG)       0x2008)
#define PS_IOA_WakeUp_Mask     ((volatile  REG)       0x2009)   // New Register

#define PS_IOA_DA              ((volatile  REG)       0x2000)
#define PS_IOA_BU              ((volatile  REG)       0x2001)
#define PS_IOA_DI              ((volatile  REG)       0x2002)
#define PS_IOA_AT              ((volatile  REG)       0x2003)
#define PS_IOB_DA              ((volatile  REG)       0x2004)
#define PS_IOB_BU              ((volatile  REG)       0x2005)
#define PS_IOB_DI              ((volatile  REG)       0x2006)
#define PS_IOB_AT              ((volatile  REG)       0x2007)
#define PS_IOX_CT              ((volatile  REG)       0x2008)
